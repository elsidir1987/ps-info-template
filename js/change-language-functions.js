var languageContent = {
    greek: {
      languageBtn: "EL",
      mainTitle: "Επίδομα Γέννησης παιδιού",
      pageTitle: "Αίτηση Επιδόματος Γέννησης",
      infoTitle: "Πληροφορίες για την χορήγηση Επίδοματος Γέννησης",
      subTitle1: "Αυτό το ερωτηματολόγιο μπορεί να σας βοηθήσει να βρείτε αν δικαιούστε να λάβετε το επίδομα γέννησης.",
      ...
      footerText: "Αυτό το έργο δημιουργήθηκε για τις ανάγκες της εργασίας κατά τη διάρκεια των ΠΜΣ σπουδών στο Πανεπιστήμιο Μακεδονίας.",
      and: "και",
      student1: "Σιδηράκη Ελένη",
    ...
    english: {
      languageBtn: "EN",
      mainTitle: "Βenefit for the Birth of a Child",
      pageTitle: "Application for Benefit for the Birth of a Child",
      infoTitle: "Information on the issue of Benefit for the Birth of a Child",
      subTitle1: "This questionnaire can help you determine if you are eligible to receive the the benefit for the birth of a child.",
      ...
      footerText: "This project was created for the needs of our thesis for Master in Applied Informatics at the University of Macedonia.",
      and: "and",
      student1: "Sidiraki Eleni",
